...
const copy = {
  en: {
    ...
    analysisTitle: "June 20 update",
    analysisText: "The June 20 update incorporates polling published through June 17, 88 days before the election. Since the SCB release, new Sifo, Ipsos, and Novus polls continue to show C+S+V+MP ahead, but with a slightly narrower margin. The latest Novus poll has C+S+V+MP at 54.0%, compared to 44.4% for M+L+KD+SD. The Liberal Party (L) remains below the threshold at 2.2%, while the Christian Democrats (KD) are above it at 5.6%. These results keep the model leaning clearly toward the opposition, but pull it back slightly from the June 4 update: C+S+V+MP's election-day forecast falls to 53.9%, the Tidö bloc rises to 44.2%, and the probability of a C+S+V+MP majority among parties above 4% decreases from 93.2% to 92.4%.",
    analysisTextSecond: "Notably, S+V+MP alone now achieves a majority in 54.0% of simulations, down from 60.2%. This is mainly because the model estimate for S falls by about 1.1 percentage points, while V and MP rise somewhat. The threshold calculations still matter: L remains projected to stay below 4% in most simulations, while KD is now more often above the threshold. In this analysis, votes for parties below the threshold are excluded prior to the majority assessment.",
  ...
  sv: {
    ...
    analysisTitle: "Uppdatering 20 juni",
    analysisText: "Uppdateringen den 20 juni tar in mätningar publicerade till och med den 17 juni, 88 dagar före valet. Sedan SCB-mätningen har nya mätningar från Sifo, Ipsos och Novus fortsatt att visa ett övertag för C+S+V+MP, men med något mindre marginal. Den senaste Novusmätningen ger C+S+V+MP 54,0 procent, jämfört med 44,4 procent för M+L+KD+SD. Liberalerna (L) ligger fortsatt under spärren på 2,2 procent, medan Kristdemokraterna (KD) ligger över den på 5,6 procent. Resultaten gör att modellen fortfarande lutar tydligt mot oppositionen, men drar tillbaka den något från uppdateringen den 4 juni: C+S+V+MP:s valprognos faller till 53,9 procent, Tidöblocket stiger till 44,2 procent och sannolikheten för att C+S+V+MP får majoritet bland partier över 4 procent minskar från 93,2 till 92,4 procent.",
    analysisTextSecond: "Noterbart är att S+V+MP ensamma nu når majoritet i 54,0 procent av simuleringarna, ned från 60,2 procent. Det beror främst på att modellens skattning för S faller med ungefär 1,1 procentenheter, medan V och MP stiger något. Spärrberäkningarna spelar fortfarande roll: L väntas fortsatt ligga under 4 procent i de flesta simuleringar, medan KD nu oftare ligger över spärren. I den här analysen räknas röster på partier under spärren bort innan majoriteten bedöms.",
